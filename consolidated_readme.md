...
- Multi-language interface (English, Spanish, Catalan)
...
|--------|----------|------|--------|----------|---------------|
| Use a Framework as backend | WEB | Major | 2 | All | [PONG_BACKEND_DOCUMENTATION.md](./srcs/backend/doc/PONG_BACKEND_DOCUMENTATION.md) |
...
| Use an ORM for the database | WEB | Minor | 1 | Luis | [PONG_BACKEND_DOCUMENTATION.md](./srcs/backend/doc/PONG_BACKEND_DOCUMENTATION.md) |
...
| Two-Factor Authentication (2FA) | User Management | Minor | 1 | Luis | [TWO_FACTOR_AUTHENTICATION_DOCUMENTATION.md](./srcs/totp/doc/TWO_FACTOR_AUTHENTICATION_DOCUMENTATION.md) · [2FA_LOGIN_FLOW_ACTUAL_IMPLEMENTATION.md](./srcs/totp/doc/2FA_LOGIN_FLOW_ACTUAL_IMPLEMENTATION.md) |
| Web-based Pong game | Gaming & User Experience | Major | 2 | Adria / Natalia | [PONG_FRONTEND_DOCUMENTATION.md](./srcs/frontend/doc/PONG_FRONTEND_DOCUMENTATION.md) · [PONG_BACKEND_DOCUMENTATION.md](./srcs/backend/doc/PONG_BACKEND_DOCUMENTATION.md) |
| Remote players (real-time multiplayer) | Gaming & User Experience | Major | 2 | Natalia | [WEBSOCKET_SYSTEM_DOCUMENTATION.md](./srcs/backend/doc/WEBSOCKET_SYSTEM_DOCUMENTATION.md) · [PONG_FRONTEND_DOCUMENTATION.md](./srcs/frontend/doc/PONG_FRONTEND_DOCUMENTATION.md) |
| Monitoring — Prometheus + Grafana | DevOps | Major | 2 | Natalia / Luis | [prometheus_documentation.md](./srcs/prometheus/doc/prometheus_documentation.md) · [grafana_documentation.md](./srcs/grafana/doc/grafana_documentation.md) |
| OAuth 2.0 (42 & Google) | User Management | Major | 2 | Xavi | [OAUTH.md](./srcs/backend/doc/OAUTH.md) |
| Chat system | Gaming & User Experience | Major | 2 | Natalia | [CHAT_SYSTEM_DOCUMENTATION.md](./srcs/backend/doc/CHAT_SYSTEM_DOCUMENTATION.md) |
