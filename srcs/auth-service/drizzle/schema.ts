import { pgTable, smallint, jsonb, char, varchar, boolean, foreignKey, unique, integer, text, timestamp, date, interval, doublePrecision, primaryKey } from "drizzle-orm/pg-core"
import { sql } from "drizzle-orm"

// (citext y bytea) son tipos específicos de Postgres que el generador 
// automático no siempre sabe mapear a la primera.

// Ajustamos la tabla player para que el Auth Service funcione correctamente y 
// no de errores de compilación.
//
// pMail: Cambia unknown por text (citext se comporta como texto en TypeScript).
// pTotpSecret: Cambia unknown por customType. 
// Drizzle permite definir el tipo bytea de Postgres así.
